    ...
    <div class="position-sticky" >
        <div class="list-group list-group-flush mx-3 mt-4" style="margin: 0">
            <div class="footer_logo" style="text-align: center; margin-bottom: 0">
                <a href="home"><img src="images/SEN.jpg" alt="Logo" style="height: 53px"></a>
            </div>
            ...
            <a href="order" class="list-group-item list-group-item-action" style="margin-top: 10px">
               
                <span style="font-size: 16px; font-weight: 600">Order</span>
            </a>
