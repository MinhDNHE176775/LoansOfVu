                                ...
                                <tbody id="contentt">
                                    <c:forEach items="${requestScope.listUser}" var="u">
                                        <tr>
                                            ...
                                            <td class="text_page"  style="font-weight: 500">${u.email}</td>
                                            ...
                                            <td class="text_page"  style="padding: 0 12px 16px">
                                                <a href="deleteaccount?username=${u.userName}" onclick="return confirm('Bạn có chắc chắn muốn xóa tài khoản?')">
